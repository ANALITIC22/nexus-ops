...
// ── Auth / Cuentas Admin ─────────────────────────────────────
import {
  initAdminAuth, loginAdminUI, logoutAdminUI,
  renderCuentasAdmin, recargarAdmins,
  guardarAdmin, verMatricesAdmin, confirmarEliminarAdmin,
  toggleLoginEye, toggleModalEye, checkPasswordStrength
} from './js/cuentas_admin.js';
import { limpiarFiltroAdmin } from './js/matrices.js';
...
import { initNotifications, refreshNotifPanel } from './js/notifications.js';
...
window.recargarAdmins         = recargarAdmins;
window.guardarAdmin           = guardarAdmin;
window.verMatricesAdmin       = verMatricesAdmin;
window.confirmarEliminarAdmin = confirmarEliminarAdmin;
window.limpiarFiltroAdmin     = limpiarFiltroAdmin;
window.toggleLoginEye         = toggleLoginEye;
window.toggleModalEye         = toggleModalEye;
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ── Auth multi-admin ──────────────────────────────────────
  // Inicia el observer de Firebase Auth. Si hay sesión activa,
  // oculta el login y carga los datos del admin.
  initAdminAuth();
